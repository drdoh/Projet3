...
<div class="container">
  <div class="jumbotron">
      ...
      <form class="form-signin" method="post" action="index.php?action=signin">
        ...
        <br/>
        <button class="btn btn-lg btn-primary btn-block" type="submit"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Connexion</button><br/>
      </form>
      <a href="index.php"><button class="btn btn-lg btn-secondary btn-block"><i class="fa fa-home fa-fw" aria-hidden="true"></i>Retourner a l'accueil</button></a>
  </div>
</div>
